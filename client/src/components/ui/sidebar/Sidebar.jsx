...
const SideBar = () => {
  ...
  return (
    <motion.div
      ...
      className="h-screen border-r flex flex-col bg-[#1D222B] border-[#D1D5DB]"
    >
      ...
      <div className="flex items-center p-3 text-white">
        ...
        <div className="flex w-full justify-center md:hidden">
          <FaBars size={22} onClick={toggle} className="cursor-pointer" />
        </div>
        ...
        <div className="hidden md:flex items-center w-full">
          ...
          {isOpen && (
            <img
              src={productIcon}
              alt="Product Icon"
              className="w-5 h-5 object-contain ml-2 lg:ml-3"
            />
          )}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.input
              ...
              type="text"
              placeholder="Search..."
              className="ml-2 bg-transparent text-sm text-white placeholder-gray-500 focus:outline-none"
            />
          )}
        </AnimatePresence>
      </div>
